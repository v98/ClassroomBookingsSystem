...
public class ViewTimetable extends Application{
	@Override 
	...
	private static TableView addMid() {
		...
		TableColumn c1=new TableColumn("Course 1");
		TableColumn c2=new TableColumn("Course 2");
		TableColumn c3=new TableColumn("Course 3");
		TableColumn c4=new TableColumn("Course 4");
		TableColumn c5=new TableColumn("Course 5");
		tab.getColumns().addAll(c1,c2,c3,c4,c5);
